...
import { PressableNFTImage, OtherProfileHeader, InfoBox } from '../components';

const CampaignDescriptions = {
  YEEZUS:
    'Having been vocal about it for years, Ye is donating 10% of proceeds to the "Free Larry Hoover" campaign',
    ...
    return (
      <>
        ...
        <FlatList
          ...
          numColumns={2}
          keyExtractor={(item, index) => item.NFTName + uuid.v4()}
          data={props.data}
