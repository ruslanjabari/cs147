...
export default function ArtistCampaignTabs({ artist }) {
  ...
  console.log(artist, "WHAT THE ARTIST")
  switch (artist) {
    case "Kanye West":
  ...
  console.log(NFTs, "mynft f stuff")
  return (
    <>
      ...
      <Tab.Navigator
        ...
        >
          {() => <ArtistsNFTs data={NFTs[albums[0]]} name={albums[0]} />}
        </Tab.Screen>
        ...
        >
          {() => <ArtistsNFTs data={NFTs[albums[1]]} name={albums[1]} />}
        </Tab.Screen>
        ...
        >
          {() => <ArtistsNFTs data={NFTs[albums[2]]} name={albums[2]} />}
        </Tab.Screen>
